...
nohup python train_icrl.py ../config/mujoco_WGW-v0/train_ICRL_WGW-v0_without-action_by_games_max-nu-1_recon_obs_with-buffer_ppo-lag-setting1.yaml -n 1 -s 123 -l "$log_dir" > nohup_icrl.out 2>&1 &
cd ../