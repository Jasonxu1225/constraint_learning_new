    ...
    if env_id == 'highD_velocity_constraint':
        ...
        log_path_dict = {
            ...
            "ICRL_HCWithPos-v0_with-action_noise-1e-1-storebygame": [
                '../save_model/ICRL-HC/train_ICRL_HCWithPos-v0_with-action_noise-1e-1-storebygame-multi_env-Feb-22-2023-18:52-seed_123/',
            ...
            "PPO_lag_with-action_noise-1e-1-storebygame": [
                '../save_model/2.21/PPO-Lag-HC/train_ppo_lag_HCWithPos-v0-storebygame-multi_env-Feb-21-2023-19:38-seed_123/',
